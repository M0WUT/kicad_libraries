...
STANDARD_LIBRARY = "C:\\Users\\Dan\\Documents\\kicad_wut\\kicad_libraries\\Auto_Library_WUT.kicad_sym"
PREFERRED_LIBRARY = "C:\\Users\\Dan\\Documents\\kicad_wut\\kicad_libraries\\AAA_Preferred_WUT.kicad_sym"
...
with open(STANDARD_LIBRARY, "w+") as standard_library, open(
    PREFERRED_LIBRARY, "w+"
) as preferred_library:
    workbook = openpyxl.load_workbook(SOURCE_FILE)
    worksheet = workbook.active
    for library in [standard_library, preferred_library]:
        library.write(
